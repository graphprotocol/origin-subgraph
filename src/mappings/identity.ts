...
export function handleIdentityUpdated(event: IdentityUpdated): void {
  ...
  if (getIPFSData == null) {
    ...
    //
    // // TODO - you need to handle cases where multiple attestations are within one IFPS file. This just deals with one
    // TODO might be an easier way to handle this data, locations rather than names
    //
    ...
    // let attestationID = issuerName.concat('test'.concat(id))
